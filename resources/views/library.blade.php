            ...
            <section class="library">
                <div class="container library__container">
                  ...
                  <div class="library__buttons">
                    <button
                      class="button__category tablinks"
                      onclick="openTab(event, 'video')"
                    >
                      <svg
                        width="19"
                        height="12"
                    ...
                    <button
                      class="button__category button__category-active tablinks"
                  ...
                  <div class="library__wrapper tabcontent" id="video">
                    <div class="card">
                      ...
                      <div class="card__content">
                        ...
                        <a href="#" class="button newsSection__hoverButton">Смотреть видео</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="library__wrapper tabcontent tabcontentpost" id="post">
                    <div class="card">
                      ...
                      <div class="card__content">
                        <p class="text-s">Как часто нужно стричь когти своему коту?</p>
                        <p class="text-s date">16.06.23</p>
                        <a href="#" class="button newsSection__hoverButton">Читать статью</a>
                      </div>
                    </div>
                    <div class="card">
                      <img src="../../img/cat-card.jpg" alt="" class="card__image image" />
